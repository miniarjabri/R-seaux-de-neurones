...
public class CoucheEntree implements Couche<NeuroneEntree> {
    ...
    public CoucheEntree(double input, int nbNeuronnes, int nbNeuronneCoucheSuivante,double[]pp) {
        ...
        for (int i = 0; i < nbNeuronnes; i++) {
            neuronnes[i] = new NeuroneEntree(input, nbNeuronneCoucheSuivante,pp[i]);
        }
    }
